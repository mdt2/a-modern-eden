...
function wrapWithLayout(page, drizzleData) {
  var layout = page.data.layout || drizzleData.options.layouts.page;
...
function renderPage(page, drizzleData) {
  page.contents = applyTemplate(wrapWithLayout(page, drizzleData), resourceContext(page, drizzleData), drizzleData.options);
